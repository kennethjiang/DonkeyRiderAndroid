package com.example.kenneth.donkeyrider.orientation;
...
public final class OrientationProvider implements SensorEventListener {
    ...
    public OrientationProvider(Activity activity) {
		...
		this.displayOrientation = this.activity.getWindowManager().getDefaultDisplay().getRotation();
	}
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (calibrating) {
			calibrating = false;
			Editor editor = this.activity.getPreferences(Context.MODE_PRIVATE).edit();
	...
	public final void resetCalibration() {
		...
		try {
			success = this.activity.getPreferences(
